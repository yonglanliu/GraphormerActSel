...
* The model will automatically:
  * Predict pIC50 for each subtype
  * Compute predicted selectivity between subtypes
...
```bash
smiles,pIC50_subtypeA,pIC50_subtypeB,pIC50_subtypeC,sel_A_B,sel_A_C,sel_B_C
...
*	Missing subtype data is not required at inference time
...
* Multi-task learning framework for simultaneous prediction of compound activity and subtype selectivity across protein families
